...
void set_code_segment(SegmentDescriptor *descriptor, uint64_t base,
                      uint64_t limit, uint8_t dpl);

void set_data_segment(SegmentDescriptor *descriptor, uint64_t base,
                      uint64_t limit, uint8_t dpl);

void set_system_segment(SegmentDescriptor *descriptor, uint64_t base,
                        uint64_t limit, uint8_t type, uint8_t dpl);
